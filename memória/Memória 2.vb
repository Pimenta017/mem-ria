Public Class Form1
    ...
    Private Sub Imagem(quadro)
        ...
        Select Case Matriz(quadro)
            Case 0 : fig.BackgroundImage = My.Resources._1223
            Case 1 : fig.BackgroundImage = My.Resources._3221
            Case 2 : fig.BackgroundImage = My.Resources.lolelole
            Case 3 : fig.BackgroundImage = My.Resources.Cara
            Case 4 : fig.BackgroundImage = My.Resources.estrelar
            Case 5 : fig.BackgroundImage = My.Resources.televisao
        End Select
    ...
    Private Sub Clicar(sender As Object, e As EventArgs) Handles P1.Click, P2.Click, P4.Click, P3.Click, P9.Click, P8.Click, P7.Click, P6.Click, P5.Click, P12.Click, P11.Click, P10.Click
        ...
        If ganhou Then
            Beep()
            MsgBox("Ganhaste! Joga outravez ",, "Fim do Jogo")
            Call Inicializa()
        End If
    End Sub
