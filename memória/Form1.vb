Public Class Form1
    Private Sub Clicar(sender As Object, e As EventArgs) Handles P1.Click, P4.Click, P3.Click, P2.Click, P9.Click, P8.Click, P7.Click, P6.Click, P5.Click, P12.Click, P11.Click, P10.Click
        Dim fig As New PictureBox
        Dim i = Int(Rnd() * 6)
        Select Case i
            Case 0 : fig.Image = My.Resources._1223
            Case 1 : fig.Image = My.Resources._3221
            Case 2 : fig.Image = My.Resources.Cara
            Case 3 : fig.Image = My.Resources.estrelar
            Case 4 : fig.Image = My.Resources.lolelole
            Case 5 : fig.Image = My.Resources.televisao
        End Select
